 ...
 * @Purpose The administrative client for Kafka, which supports
...
public class KafkaAdminClient {
  ...
  public void createTopics() {
    ...
    try {
      // Call method execute() with retry logic
      // configured in the retry logic
  ...
  public void checkTopicsCreated() {
    ...
    for(String topic: kafkaConfigData.getTopicNamesToCreate()){
      // CUSTOM RETRY LOGIC => Wait until topics created or max
      // retry reached, increasing wait time exponentially
  ...
  // Check if schema registry is up and running
